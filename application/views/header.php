            ...
            <div class="d-flex">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item me-5">
                        <?php if($id != null){
                            ?>
                            <a class="nav-link text-white fw-bold" href="<?=base_url()?>home/logout">Logout</a>
                       <?php }
                       else{
                            ?>
          ...
          <div class="modal-body">
            ...
            <div class="mb-4 tdark-bold text-center mt-3" style='font-size:26px;'>
              ...
              <div class="mb-3 text-center">
                <button type="submit" class="btn btn-dark tdark-bold text-white w-75 rounded-pill" style="height:48px;">Sign In</button>
              </div>
            </form>
          </div>
        </div>
